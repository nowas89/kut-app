    ...
    return (
      <div>
        <MenuWrap>
          <div>
            <Nav>
              <ul>
                <li>
                  <NavLink to="/" style={{ fontFamily: "Arial" }}>
                    Karty Usług Technicznych
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/ewidencja" style={{ fontFamily: "Arial" }}>
                    Ewidencja Kart
                  </NavLink>
                </li>
                <li>
                  <NavLink to="/ewidencjaPracy" style={{ fontFamily: "Arial" }}>
          ...
          <DOlnyDiv>
            ...
            <NavLink to="/ustawienia" activeClassName="none">
        ...
        <Switch>
          ...
          <Route path="/ewidencja" >
            <TabelaEwidencyjna />
          </Route>
          <Route path="/ewidencjaPracy">
            <EwidencjaPracy />
          </Route>
