...
class OtwartaKarta extends Component {
        ...
        this.setState({
            ...
            karta: {
                ...
                edytowaneCz: {
                    ...
                    editCzWyszczegolnienie: this.props.edytowanaCz
                        .CzWyszczegolnienie,
    ...
    editCzOperacja = (e) => {
        this.setState({
            karta: {
                ...this.state.karta,
                edytowaneCz: {
                    ...this.state.karta.edytowaneCz,
                    editCzOperacja: e.target.value.toUpperCase(),
                },
            },
        });
    };
    ...
    editCzWykonawca = (e) => {
        this.setState({
            karta: {
                ...
                edytowaneCz: {
                    ...this.state.karta.edytowaneCz,
                    editCzWykonawca: e.target.value.toUpperCase(),
                },
            },
        });
    };
    editCzWyszczegolnienie = (e) => {
        this.setState({
            karta: {
                ...
                edytowaneCz: {
                    ...this.state.karta.edytowaneCz,
                    editCzWyszczegolnienie: e.target.value,
                },
            },
        });
    };
    editCzOznaczenie = (e) => {
        this.setState({
            karta: {
                ...
                edytowaneCz: {
                    ...this.state.karta.edytowaneCz,
                    editCzOznaczenie: e.target.value,
                },
            },
        });
    };
    ...
    editCzynnosci = (czynnosci) => {
        ...
        let nowaListaCz = this.state.karta.CzCzynnosci.map((czynnosc) => {
            if (czynnosc.CzOperacjaId === sprawdzanaCz.CzOperacjaId) {
                return {
                    ...
                    CzWyszczegolnienie:
                        edytowanaCzynnosc.editCzWyszczegolnienie,
    ...
    render() {
        ...
        return (
            <Wrapper>
                <SVG
                    onClick={() => window.scrollTo(0, 1000000000)}
                    width="24"
                    height="24"
             ...
             wykonania następujących prac:"
                ...
                {this.state.karta.CzCzynnosci.length > 0 ? (
                    <TabelaCzynnosci
                        zawartosCzynnosci={this.state.karta.CzCzynnosci}
                    />
                ) : null}
                    ...
                    <Czynnosci>
                        ...
                        <Container>
                            ...
                            <TextField
                                ...
                                name="karta"
                                defaultValue={
                                    this.props.edytowanaCz.CzWykonawca
                                }
                        ...
                        <Container>
                            <TextField
                                ...
                                name="karta"
                                defaultValue={
                                    this.props.edytowanaCz.CzWyszczegolnienie
                                }
                            ...
                            <TextField
                                ...
                                name="karta"
                                defaultValue={
                                    this.props.edytowanaCz.CzOznaczenie
                                }
                        ...
                        <div>
                            <Button
                                ...
                                onClick={() =>
                                    this.editCzynnosci(this.state.CzCzynnosci)
                                }
                            >
                                Zapisz zmiany
                            </Button>
                ...
                {this.props.editOperacji ? (
                    ...
                    <div style={{ display: "flex" }}>
                        <Button
                            ...
                            onClick={(e) => this.zapiszWyslijButton(e)}
                        >
                            <SaveIcon
